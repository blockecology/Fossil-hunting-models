...
This script is simply to prepare the models outputs for the final validation steps. <br><br>

```{r Loading and cleaning SDM, message = FALSE, eval=FALSE}
# Set working directory
setwd("~/Dropbox/Block et al 2015 Fossil Hunting") 

# Load attribute table of multiSDMs.shp
require(foreign)
...
gridPD <- read.dbf("Data/Grids/GridPD_val.dbf")
...
# Write dbf file 
write.dbf(FG, "Data/Grids/valPs.dbf")
```
